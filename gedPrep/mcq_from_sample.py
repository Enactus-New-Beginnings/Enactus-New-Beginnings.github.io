...
if __name__ == '__main__':
    ...
    questions_string = generate_similar_questions(extracted_text, api_key, n_questions=5)
    ...
    # Step 4: Save the questions string to a text file
    ...
    # Step 5: Save the parsed questions to a JSON file
