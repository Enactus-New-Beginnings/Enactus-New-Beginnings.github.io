            ...
            <Nav className="ml-auto" navbar>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu end>
                  ...
                  <Link
                    ...
                    style={{ textDecoration: "none" }}
                  >
                    <DropdownItem>Shelter</DropdownItem>
                  </Link>
                </DropdownMenu>
              </UncontrolledDropdown>
              <UncontrolledDropdown nav inNavbar>
              ...
              <UncontrolledDropdown nav inNavbar>
                ...
                <DropdownMenu end>
                  ...
                  >
                    <DropdownItem>
                      New Design <FontAwesomeIcon icon={solid("video")} />
                    </DropdownItem>
                  </Link>
                  <Link
                    to="/aibot"
                  ...
                  >
                    <DropdownItem>
                      AI Chatbot <FontAwesomeIcon icon={solid("video")} />
                    </DropdownItem>
                  </Link>
                </DropdownMenu>
              </UncontrolledDropdown>
